    ...
    <div class="row">
      <div class="col-md-11">
          ...
          <div class="card-header">
            Data Produk
            <a href="{{ url('admin/artikel/create') }}" class="btn btn-dark float-right"><i class="fa fa-plus ml-2"></i> tambah data</a>
            </div>
            <div class="card-body">
                  ...
                  <tr>
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          @include('utils.delete',['url' => url('admin/artikel', $artikel->id)])
                        </div>
                       </td>
                      <td> {{$artikel->judul}} </td>
